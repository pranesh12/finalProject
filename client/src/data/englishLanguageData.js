const englishLanguageData = {
  //Banner section
  banner: {
    primaryHeader: "Welcome to Chittagong hill tracts webstie",
    secondDarayHeader: "Chittagong hill tracts",
    paragraph:
  ...
  //Informatin Section
  information: {
    header: "Let's Build something amazing Together",
